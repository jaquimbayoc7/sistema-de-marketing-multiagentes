...
Aplicación Streamlit multi-agente que genera propuestas comerciales de marketing personalizadas usando LangGraph + Claude (Anthropic). Cuatro agentes especializados trabajan en cadena y entregan la propuesta en formato `.md` y `.pdf`.
...
Cada agente consume el estado compartido `MarketingProposalState` y agrega su output al mismo estado antes de pasarlo al siguiente.
